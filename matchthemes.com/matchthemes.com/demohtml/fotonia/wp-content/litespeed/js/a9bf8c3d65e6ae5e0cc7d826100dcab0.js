    ...
    (function($) {
        ...
        Sbi.prototype = {
            createPage: function(createFeeds, createFeedsArgs) {
                ...
                if ($("#sbi-builder-app").length && typeof window.sbiresizedImages === "undefined") {
                    if ($(".sbi_resized_image_data").length && typeof $(".sbi_resized_image_data").attr("data-resized") !== "undefined" && $(".sbi_resized_image_data").attr("data-resized").indexOf('{"') === 0) {
        ...
        SbiFeed.prototype = {
                ...
                if ($item.find(".sbi_photo").length && !$item.closest(".sbi").hasClass("sbi-no-ll-check")) {
                    ...
                    $item.find(".sbi_photo img").each(function() {
                        ...
                        $(this).on("load", function() {
                            if (!$(this).hasClass("sbi-replaced") && $(this).attr("src").indexOf("placeholder") > -1) {
            ...
            setResizedImages: function() {
                if ($(this.el).find(".sbi_resized_image_data").length && typeof $(this.el).find(".sbi_resized_image_data").attr("data-resized") !== "undefined" && $(this.el).find(".sbi_resized_image_data").attr("data-resized").indexOf('{"') === 0) {
            ...
            maybeRaiseSingleImageResolution: function($item, index, forceChange) {
                ...
                if (imgSrcSet.length < 1) {
                    ...
                    return
                } else if ($item.find(".sbi_link_area").length && $item.find(".sbi_link_area").attr("href") === window.sbi.options.placeholder.replace("placeholder.png", "thumb-placeholder.png") || !feed.settings.consentGiven) {
                ...
                if (newRes > currentRes || currentUrl === window.sbi.options.placeholder || forceChange) {
                    ...
                    if (feed.settings.imgRes === "auto") {
                        ...
                        $item.find(".sbi_photo img").on("load", function() {
                            ...
                            if ($this_image.get(0).naturalWidth !== 1e3 && newAspectRatio > aspectRatio && !checked) {
                                if (feed.settings.debugEnabled) {
            ...
            maybeRaiseImageResolution: function(justNew) {
                ...
                $(feed.el).find(itemsSelector).each(function(index) {
                    if (!$(this).hasClass("sbi_num_diff_hide") && $(this).find(".sbi_photo").length && typeof $(this).find(".sbi_photo").attr("data-img-src-set") !== "undefined") {
